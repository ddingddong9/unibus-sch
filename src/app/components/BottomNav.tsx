...
export default function BottomNav() {
  ...
  return (
    <div className="fixed backdrop-blur-[12px] bg-[rgba(255,255,255,0.95)] bottom-0 content-stretch flex items-center justify-center left-1/2 -translate-x-1/2 max-w-[430px] pb-[32px] pt-[13px] px-[24px] w-full border-t border-[#e2e8f0] z-50">
