...
function MovingRouteGraphic() {
  return (
    <div className="relative h-[318px] overflow-hidden rounded-lg border border-[#dbe4ef] bg-white shadow-sm">
      ...
      <motion.div
        className="absolute left-[22px] top-[222px]"
        animate={{
          x: [0, 82, 168, 254, 292],
          y: [0, -72, -142, -96, -8],
          rotate: [-18, -28, 24, 46, 8],
        }}
      ...
      <motion.div
        className="absolute bottom-5 left-5 right-5 rounded-lg border border-[#e2e8f0] bg-white p-4 shadow-[0_18px_28px_rgba(15,23,42,0.08)]"
    ...
    <motion.div variants={fadeUp} className="rounded-lg border border-[#e2e8f0] bg-white p-5 shadow-sm">
      ...
      <div className="space-y-2">
        {noticeItems.map((item) => (
          <motion.div key={item} variants={fadeUp} className="flex items-center gap-3 rounded-lg bg-[#f8fafc] px-4 py-3">
      ...
      <div className="min-h-full bg-[#f8fafc] px-5 pb-8 pt-safe">
        ...
        <main>
          ...
          <motion.section className="py-8" {...sectionMotion}>
            <motion.p variants={fadeUp} className="font-['Public_Sans'] text-[12px] font-bold text-[#64748b]">
              앱에서 바로 확인하는 것들
            </motion.p>
            <motion.h2 variants={fadeUp} className="mt-1 font-['Public_Sans'] text-[24px] font-extrabold text-[#0f172a]">
              복잡한 정보는 정리하고,
              <br />
              필요한 순간에만 보여줍니다
            </motion.h2>
          ...
          <motion.section className="rounded-lg border border-[#dbe4ef] bg-white p-5 shadow-sm" {...sectionMotion}>
            <motion.p variants={fadeUp} className="font-['Public_Sans'] text-[12px] font-bold text-[#64748b]">
              이용 흐름
            </motion.p>
            <motion.h2 variants={fadeUp} className="mt-1 font-['Public_Sans'] text-[22px] font-extrabold text-[#0f172a]">
              출발 전에 한 번만 확인하세요
            </motion.h2>
            <div className="mt-5 space-y-4">
              {[
                ...
                <motion.div key={step} variants={fadeUp} className="flex items-start gap-3">
