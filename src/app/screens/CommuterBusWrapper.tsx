...
export default function CommuterBusWrapper() {
  ...
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full">
      <div className="bg-white content-stretch flex flex-col items-start max-w-[430px] min-h-screen overflow-auto pb-[94px] relative shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-full">
        {/* Header */}
        <div className="sticky top-0 z-20 bg-white w-full">
          <div className="backdrop-blur-[6px] bg-[rgba(255,255,255,0.9)] flex items-center justify-between pb-[12px] pt-[48px] px-[16px] w-full">
            <button
